...
export interface ApiMethodicPageMethodicPage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: '';
    displayName: 'Methodic Page';
    pluralName: 'methodic-pages';
    singularName: 'methodic-page';
  };
  options: {
  ...
  attributes: {
    ...
    how: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::methodic-page.methodic-page'
    > &
      Schema.Attribute.Private;
    ...
    whom: Schema.Attribute.Text;
  };
}

export interface ApiPresetCollectionPresetCollection
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    colorsCount: Schema.Attribute.Integer &
...
export interface ApiPresetPreset extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    beforeAfterPhotos: Schema.Attribute.Component<'shared.before-after', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text &
    ...
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::preset.preset'>;
    name: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiWithLoveBackgroundWithLoveBackground
  extends Struct.SingleTypeSchema {
  collectionName: 'with_love_backgrounds';
  info: {
    displayName: 'With Love Background';
    pluralName: 'with-love-backgrounds';
    singularName: 'with-love-background';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::with-love-background.with-love-background'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiWorksInAboutBlockWorksInAboutBlock
  extends Struct.SingleTypeSchema {
  collectionName: 'works_in_about_blocks';
  info: {
    displayName: 'Works in About Block';
    pluralName: 'works-in-about-blocks';
    singularName: 'works-in-about-block';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::works-in-about-block.works-in-about-block'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
